...
namespace Let3arafo.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <summary> CTor</summary>
		/// <param name="id">PK value for Company which data should be fetched into this Company object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public CompanyEntity(System.Int32 id):base("CompanyEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this CompanyEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public CompanyEntity(System.Int32 id, IValidator validator):base("CompanyEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoUsers()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(UserFields.CompanyId, null, ComparisonOperator.Equal, this.Id));
			return bucket;
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<UserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))), (IEntityRelation)GetRelationsForField("Users")[0], (int)Let3arafo.Data.EntityType.CompanyEntity, (int)Let3arafo.Data.EntityType.UserEntity, 0, null, null, null, null, "Users", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <summary> The Id property of the Entity Company<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Company"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 Id
		{
			get { return (System.Int32)GetValue((int)CompanyFieldIndex.Id, true); }
			set	{ SetValue((int)CompanyFieldIndex.Id, value); }
		}

		/// <summary> The Name property of the Entity Company<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Company"."Name"<br/>
		...
		{ 
			get { return (int)Let3arafo.Data.EntityType.CompanyEntity; }
		}
