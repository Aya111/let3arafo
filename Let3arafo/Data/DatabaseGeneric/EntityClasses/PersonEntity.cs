...
namespace Let3arafo.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public PersonEntity(System.Int32 id):base("PersonEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this PersonEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PersonEntity(System.Int32 id, IValidator validator):base("PersonEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Users":
					toReturn.Add(Relations.UserEntityUsingPersonId);
					break;
				default:
					break;				
			}
		...
		public virtual IRelationPredicateBucket GetRelationInfoUsers()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(UserFields.PersonId, null, ComparisonOperator.Equal, this.Id));
			return bucket;
		}
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("IdScanPath", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("NationalId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("RestOfName", fieldHashtable);
		}
		#endregion
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<UserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))), (IEntityRelation)GetRelationsForField("Users")[0], (int)Let3arafo.Data.EntityType.PersonEntity, (int)Let3arafo.Data.EntityType.UserEntity, 0, null, null, null, null, "Users", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <remarks>Mapped on  table field: "Person"."BirthDate"<br/>
		...
		/// <remarks>Mapped on  table field: "Person"."Gender"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallInt, 5, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int16 Gender
		{
			get { return (System.Int16)GetValue((int)PersonFieldIndex.Gender, true); }
			set	{ SetValue((int)PersonFieldIndex.Gender, value); }
		}

		/// <summary> The Id property of the Entity Person<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Person"."Id"<br/>
		...
		/// <summary> The IdScanPath property of the Entity Person<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Person"."IdScanPath"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 1000<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String IdScanPath
		{
			get { return (System.String)GetValue((int)PersonFieldIndex.IdScanPath, true); }
			set	{ SetValue((int)PersonFieldIndex.IdScanPath, value); }
		}

		/// <summary> The NationalId property of the Entity Person<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Person"."NationalId"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 NationalId
		{
			get { return (System.Int64)GetValue((int)PersonFieldIndex.NationalId, true); }
			set	{ SetValue((int)PersonFieldIndex.NationalId, value); }
		}

		/// <summary> The RestOfName property of the Entity Person<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Person"."RestOfName"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 100<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String RestOfName
		{
			get { return (System.String)GetValue((int)PersonFieldIndex.RestOfName, true); }
			set	{ SetValue((int)PersonFieldIndex.RestOfName, value); }
		}
		...
		{
			get { return GetOrCreateEntityCollection<UserEntity, UserEntityFactory>("Person", true, false, ref _users);	}
		}
		...
		{ 
			get { return (int)Let3arafo.Data.EntityType.PersonEntity; }
		}
