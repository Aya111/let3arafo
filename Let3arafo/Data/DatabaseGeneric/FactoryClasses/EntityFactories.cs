...
namespace Let3arafo.Data.FactoryClasses
{
	...
	{
		private readonly Let3arafo.Data.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, Let3arafo.Data.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		{
			return GeneralEntityFactory.Create((Let3arafo.Data.EntityType)entityTypeValue);
		}
	...
	/// <summary>Factory to create new, empty CommunityEntity objects.</summary>
	[Serializable]
	public partial class CommunityEntityFactory : EntityFactoryBase2<CommunityEntity> {
		/// <summary>CTor</summary>
		public CommunityEntityFactory() : base("CommunityEntity", Let3arafo.Data.EntityType.CommunityEntity, false) { }
		
		/// <summary>Creates a new CommunityEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
			IEntity2 toReturn = new CommunityEntity(fields);
			// __LLBLGENPRO_USER_CODE_REGION_START CreateNewCommunityUsingFields
			// __LLBLGENPRO_USER_CODE_REGION_END
			return toReturn;
		}
	...
	/// <summary>Factory to create new, empty CommunityCategoryEntity objects.</summary>
	[Serializable]
	public partial class CommunityCategoryEntityFactory : EntityFactoryBase2<CommunityCategoryEntity> {
		/// <summary>CTor</summary>
		public CommunityCategoryEntityFactory() : base("CommunityCategoryEntity", Let3arafo.Data.EntityType.CommunityCategoryEntity, false) { }
		
		/// <summary>Creates a new CommunityCategoryEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
			IEntity2 toReturn = new CommunityCategoryEntity(fields);
			// __LLBLGENPRO_USER_CODE_REGION_START CreateNewCommunityCategoryUsingFields
			// __LLBLGENPRO_USER_CODE_REGION_END
			return toReturn;
		}
		#region Included Code
	...
	/// <summary>Factory to create new, empty CommunityUserEntity objects.</summary>
	[Serializable]
	public partial class CommunityUserEntityFactory : EntityFactoryBase2<CommunityUserEntity> {
		/// <summary>CTor</summary>
		public CommunityUserEntityFactory() : base("CommunityUserEntity", Let3arafo.Data.EntityType.CommunityUserEntity, false) { }
		
		/// <summary>Creates a new CommunityUserEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
			IEntity2 toReturn = new CommunityUserEntity(fields);
			// __LLBLGENPRO_USER_CODE_REGION_START CreateNewCommunityUserUsingFields
			// __LLBLGENPRO_USER_CODE_REGION_END
			return toReturn;
		}
		#region Included Code
	...
	public partial class CompanyEntityFactory : EntityFactoryBase2<CompanyEntity> {
		/// <summary>CTor</summary>
		public CompanyEntityFactory() : base("CompanyEntity", Let3arafo.Data.EntityType.CompanyEntity, false) { }
	...
	public partial class PersonEntityFactory : EntityFactoryBase2<PersonEntity> {
		/// <summary>CTor</summary>
		public PersonEntityFactory() : base("PersonEntity", Let3arafo.Data.EntityType.PersonEntity, false) { }
	...
	[Serializable]
	public partial class PostEntityFactory : EntityFactoryBase2<PostEntity> {
		/// <summary>CTor</summary>
		public PostEntityFactory() : base("PostEntity", Let3arafo.Data.EntityType.PostEntity, false) { }
	...
	/// <summary>Factory to create new, empty PostContentEntity objects.</summary>
	[Serializable]
	public partial class PostContentEntityFactory : EntityFactoryBase2<PostContentEntity> {
		/// <summary>CTor</summary>
		public PostContentEntityFactory() : base("PostContentEntity", Let3arafo.Data.EntityType.PostContentEntity, false) { }
		
		/// <summary>Creates a new PostContentEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
			IEntity2 toReturn = new PostContentEntity(fields);
			// __LLBLGENPRO_USER_CODE_REGION_START CreateNewPostContentUsingFields
			// __LLBLGENPRO_USER_CODE_REGION_END
			return toReturn;
		}
		#region Included Code
	...
	public partial class UserEntityFactory : EntityFactoryBase2<UserEntity> {
		/// <summary>CTor</summary>
		public UserEntityFactory() : base("UserEntity", Let3arafo.Data.EntityType.UserEntity, false) { }
	...
	public static class EntityFactoryFactory
	{
		...
		{
			Array entityTypeValues = Enum.GetValues(typeof(Let3arafo.Data.EntityType));
			foreach(int entityTypeValue in entityTypeValues)
			{
				IEntity2 dummy = GeneralEntityFactory.Create((Let3arafo.Data.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the Let3arafo.Data.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(Let3arafo.Data.EntityType typeOfEntity)
		{
	...
	{
		/// <summary>Gets the factory of the Entity type with the Let3arafo.Data.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (Let3arafo.Data.EntityType)Enum.Parse(typeof(Let3arafo.Data.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}
		...
		{
			return new DynamicRelation((Let3arafo.Data.EntityType)Enum.Parse(typeof(Let3arafo.Data.EntityType), leftOperandEntityName, false), joinType, (Let3arafo.Data.EntityType)Enum.Parse(typeof(Let3arafo.Data.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		...
		{
			return new DynamicRelation(leftOperand, joinType, (Let3arafo.Data.EntityType)Enum.Parse(typeof(Let3arafo.Data.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <summary>Implementation of the routine which gets the factory of the Entity type with the Let3arafo.Data.EntityType value passed in</summary>
		/// <param name="entityTypeValue">The entity type value.</param>
		/// <returns>the entity factory of the entity type or null if not found</returns>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue)
		{
			return EntityFactoryFactory.GetFactory((Let3arafo.Data.EntityType)entityTypeValue);
		}
