...
namespace Let3arafo.Data.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		/// <summary>Creates and returns a new EntityQuery for the Community entity</summary>
		public EntityQuery<CommunityEntity> Community
		{
			get { return Create<CommunityEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the CommunityCategory entity</summary>
		public EntityQuery<CommunityCategoryEntity> CommunityCategory
		{
			get { return Create<CommunityCategoryEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the CommunityUser entity</summary>
		public EntityQuery<CommunityUserEntity> CommunityUser
		{
			get { return Create<CommunityUserEntity>(); }
		}
		...
		/// <summary>Creates and returns a new EntityQuery for the Post entity</summary>
		public EntityQuery<PostEntity> Post
		{
			get { return Create<PostEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the PostContent entity</summary>
		public EntityQuery<PostContentEntity> PostContent
		{
			get { return Create<PostContentEntity>(); }
		}
