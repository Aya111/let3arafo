...
namespace SK.Framework
{
    ...
    {
        private static SortedDictionary<string, string> _table;
        ...
        public static string GetSupportedWebAssetFileExtension(string mimeType)
        {
            switch (mimeType)
            {
        ...
        private static SortedDictionary<string, string> LoadTable()
        {
            ...
            types.Add(".otf", "application/octet-stream");
            ...
            types.Add(".woff", "application/x-font-woff");
