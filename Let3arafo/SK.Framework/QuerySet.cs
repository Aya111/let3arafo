...
namespace SK.Framework
{
    ...
    {
        public static IQuerySetOne<T> One<T>(T item) where T : class => new QuerySetOne<T>(item);

        public static IQuerySetMany<T> Many<T>(List<T> items) where T : class => new QuerySetMany<T>(items);

        public static QueryResults<T> Paging<T>(List<T> results, int total) where T : class => new QueryResults<T>(results, total);
    }
